...
const MILESTONES = [
  ...
  },
  {
    ...
    institution: 'IEEE Filed • 3 Papers • 5+ Systems',
    description: 'Thinking in systems, not scripts. Building RL-based simulations (CX-Twin, AutoPilot), filing research at IEEE, and architecting intelligent platforms that learn from real-world dynamics.',
