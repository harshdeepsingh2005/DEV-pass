...
const CoverSpread = () => (
  <div className="h-full flex flex-col items-center justify-between text-center px-8 py-8 relative leather-grain">
    ...
    <div className="flex flex-col items-center pt-1 relative z-10">
      ...
      <p className="font-mrz text-gold/90 font-bold text-[7px] tracking-[0.5em] uppercase mt-2">
        No. DEV-2024-0137
      </p>
      <p className="font-stamp text-gold/90 font-bold text-[10px] tracking-[0.5em] uppercase mt-1">
        Portfolio
      </p>
    ...
    <div className="flex flex-col items-center relative z-10">
      ...
      <p className="font-stamp text-gold/90 font-bold text-[11px] sm:text-xs tracking-[0.3em] uppercase">
        Harshdeep Singh
      </p>
      <p className="font-stamp text-gold/90 font-bold text-[8px] sm:text-[9px] tracking-[0.2em] uppercase mt-1">
    ...
    <div className="flex flex-col items-center pb-1 relative z-10">
      <div className="flex gap-10 mb-2">
        <div className="text-center">
          <p className="font-stamp text-gold/90 font-bold text-[7px] tracking-[0.2em] uppercase">Issued</p>
          <p className="font-stamp text-gold/90 font-bold text-[9px] tracking-wider mt-0.5">2020</p>
        </div>
        <div className="text-center">
          <p className="font-stamp text-gold/90 font-bold text-[7px] tracking-[0.2em] uppercase">Expires</p>
          <p className="font-stamp text-gold/90 font-bold text-[9px] tracking-wider mt-0.5">NEVER</p>
        </div>
      </div>
      {/* Microtext security line */}
      <p className="font-mrz text-gold/90 font-bold text-[4px] tracking-[0.8em] uppercase select-none">
