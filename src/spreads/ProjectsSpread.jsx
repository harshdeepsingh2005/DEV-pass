...
const ProjectsSpread = () => (
  <div className="grid grid-cols-2 h-full">
    ...
    <div className="p-4 sm:p-5 border-r border-black/[0.04] flex flex-col relative">
      <span className="absolute bottom-2 left-3 font-stamp text-[7px] text-medium-gray/20 tracking-widest">P 04</span>
    ...
    <div className="p-4 sm:p-5 flex flex-col relative">
      <span className="absolute bottom-2 right-3 font-stamp text-[7px] text-medium-gray/20 tracking-widest">P 05</span>
